...
class Error1(BaseModel):
    ...
    error: Optional[ErrorProperties1] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["document_id", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "error": ErrorProperties1.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
