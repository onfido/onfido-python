...
class DocumentBreakdownDataConsistencyBreakdown(BaseModel):
    """
    ...
    nationality: Optional[DocumentBreakdownDataComparisonBreakdownIssuingCountry] = None
    last_name: Optional[DocumentBreakdownDataComparisonBreakdownIssuingCountry] = None
    multiple_data_sources_present: Optional[DocumentBreakdownDataComparisonBreakdownIssuingCountry] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date_of_expiry", "document_numbers", "issuing_country", "document_type", "date_of_birth", "gender", "first_name", "nationality", "last_name", "multiple_data_sources_present"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentBreakdownDataConsistencyBreakdown from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of multiple_data_sources_present
        if self.multiple_data_sources_present:
            _dict['multiple_data_sources_present'] = self.multiple_data_sources_present.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentBreakdownDataConsistencyBreakdown from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nationality": DocumentBreakdownDataComparisonBreakdownIssuingCountry.from_dict(obj["nationality"]) if obj.get("nationality") is not None else None,
            ...
            "multiple_data_sources_present": DocumentBreakdownDataComparisonBreakdownIssuingCountry.from_dict(obj["multiple_data_sources_present"]) if obj.get("multiple_data_sources_present") is not None else None
        })
