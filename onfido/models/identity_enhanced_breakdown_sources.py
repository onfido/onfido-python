...
class IdentityEnhancedBreakdownSources(BaseModel):
    """
    Asserts if any sources that an applicant's details have been verified against have produced a match.
    """ # noqa: E501
    result: Optional[StrictStr] = None
    breakdown: Optional[IdentityEnhancedBreakdownSourcesBreakdown] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IdentityEnhancedBreakdownSources from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IdentityEnhancedBreakdownSources from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": IdentityEnhancedBreakdownSourcesBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None
        })
