...
class SdkTokenBuilder(BaseModel):
    """
    SdkTokenBuilder
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["applicant_id", "referrer", "application_id", "cross_device_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SdkTokenBuilder from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SdkTokenBuilder from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cross_device_url": obj.get("cross_device_url")
        })
