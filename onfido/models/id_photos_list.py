...
class IdPhotosList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id_photos"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id_photos": [IdPhoto.from_dict(_item) for _item in obj["id_photos"]] if obj.get("id_photos") is not None else None
        })
