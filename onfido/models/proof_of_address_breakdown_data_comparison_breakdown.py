...
class ProofOfAddressBreakdownDataComparisonBreakdown(BaseModel):
    """
    ProofOfAddressBreakdownDataComparisonBreakdown
    """ # noqa: E501
    address: Optional[DocumentBreakdownDataComparisonBreakdownIssuingCountry] = None
    ...
    __properties: ClassVar[List[str]] = ["address", "first_name", "last_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProofOfAddressBreakdownDataComparisonBreakdown from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProofOfAddressBreakdownDataComparisonBreakdown from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "address": DocumentBreakdownDataComparisonBreakdownIssuingCountry.from_dict(obj["address"]) if obj.get("address") is not None else None,
