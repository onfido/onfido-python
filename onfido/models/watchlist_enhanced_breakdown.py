...
class WatchlistEnhancedBreakdown(BaseModel):
    """
    ...
    monitored_lists: Optional[WatchlistAmlBreakdownLegalAndRegulatoryWarnings] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["politically_exposed_person", "sanction", "adverse_media", "monitored_lists"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WatchlistEnhancedBreakdown from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of monitored_lists
        if self.monitored_lists:
            _dict['monitored_lists'] = self.monitored_lists.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WatchlistEnhancedBreakdown from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "monitored_lists": WatchlistAmlBreakdownLegalAndRegulatoryWarnings.from_dict(obj["monitored_lists"]) if obj.get("monitored_lists") is not None else None
        })
