...
class KnownFacesPropertiesMatchesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicant_id", "score", "media_id", "media_type", "suspected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KnownFacesPropertiesMatchesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KnownFacesPropertiesMatchesInner from a dict"""
        if obj is None:
            return None
