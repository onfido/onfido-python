...
class WatchlistMonitor(BaseModel):
    ...
    WatchlistMonitor
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier for the monitor.")
    ...
    report_name: StrictStr = Field(description="The name of the report type the monitor creates. Can be either \"watchlist_standard\" or \"watchlist_aml\".")
    ...
    sandbox: Optional[StrictBool] = Field(default=False, description="Indicates whether the object was created in the sandbox or not.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "created_at", "deleted_at", "applicant_id", "report_name", "tags", "sandbox"]
