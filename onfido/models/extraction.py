...
class Extraction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["document_id", "document_classification", "extracted_data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "document_classification": ExtractionDocumentClassification.from_dict(obj["document_classification"]) if obj.get("document_classification") is not None else None,
            "extracted_data": ExtractionExtractedData.from_dict(obj["extracted_data"]) if obj.get("extracted_data") is not None else None
        })
