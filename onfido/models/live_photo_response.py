...
class LivePhotoResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "href", "download_href", "file_name", "file_type", "file_size"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LivePhotoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LivePhotoResponse from a dict"""
        if obj is None:
            return None
