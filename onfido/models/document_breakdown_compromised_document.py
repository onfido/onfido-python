...
class DocumentBreakdownCompromisedDocument(BaseModel):
    """
    ...
    breakdown: Optional[DocumentBreakdownCompromisedDocumentBreakdown] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DocumentBreakdownCompromisedDocument from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DocumentBreakdownCompromisedDocument from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": DocumentBreakdownCompromisedDocumentBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None
        })
