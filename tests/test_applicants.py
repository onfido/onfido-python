...
def test_list_applicants(requests_mock):
    ...
    assert history[0].url == "https://api.onfido.com/v3.1/applicants?include_deleted=True&per_page=5&page=2"
