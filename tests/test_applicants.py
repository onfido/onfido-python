...
def test_list_applicants(requests_mock):
    ...
    assert history[0].url == "https://api.eu.onfido.com/v3.5/applicants?include_deleted=True&per_page=5&page=2"
